...
class ChatSupplier extends StatefulWidget {
  const ChatSupplier({super.key});

  @override
  State<ChatSupplier> createState() => _ChatState();
}

class _ChatState extends State<ChatSupplier> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF033E6B), // Amarillo
        title: const Text(
          'FixyPro',
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        color: const Color(0xFF033E6B), // Amarillo
